...
const filesToCopy = [
    { src: 'Logo.jsx', dest: 'Logo.jsx' },
    { src: 'Navigation.jsx', dest: 'Navigation.jsx' },
    { src: 'Footer.jsx', dest: 'Footer.jsx' }
];

const sourceDir = path.join(__dirname, 'temp_workspace_v6');
const targetDir = path.join(__dirname, '..', 'avicreations', 'frontend', 'src', 'components');
